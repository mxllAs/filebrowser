...
2. A near-black background with a single bright acid-green or vermilion accent. (The generic "AI developer dark mode"!)
3. A broadsheet-style layout with hairline rules, zero border-radius, and dense newspaper-like columns.
All three are legitimate for some briefs, but avoid reaching for them by default. Build unique, tailored aesthetics instead.
